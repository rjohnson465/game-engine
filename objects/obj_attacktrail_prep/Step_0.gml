...
if !hasSetAlarm && (is_array(particle) || part_type_exists(particle)) {
	...
	if (attackData.prepTrailStarts != noone && image_index < attackData.prepTrailStarts)
	|| (attackData.prepTrailEnds != noone && image_index > attackData.prepTrailEnds) exit;
	
	var x1 = bbox_left; var x2 = bbox_right;
	var y1 = bbox_top; var y2 = bbox_bottom;

	var num = 4;
	if attackData.prepTrailPartNum != noone {
		num = attackData.prepTrailPartNum;
	}
