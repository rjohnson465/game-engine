...
if rightHandItem.spriteName != "unarmed" {
	drawItem(rightHandItem,rightHandItem1SlotX,rightHandItem1SlotY,0);
}
...
if rightRing1 {
	drawItem(rightRing1,rightRing1SlotX,rightRing1SlotY,0);
}
// right ring 2
drawEquipmentSlot(rightRing2SlotX,rightRing2SlotY, EquipmentSlots.RightRing2);
if rightRing2 {
	drawItem(rightRing2,rightRing2SlotX,rightRing2SlotY,0);
}
// description box
