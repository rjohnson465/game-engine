...
emitter1 = part_emitter_create(system);
...
part_type_size(cinder,0.01,.07,0,0);
...
part_type_size(smoke,.07,.11,0,0);
...
part_emitter_region(system, emitter1, x-16, x-5, y-1, y+1, ps_shape_diamond, ps_distr_gaussian);
part_emitter_region(system, emitter2, x+5, x+16, y-1, y+1, ps_shape_diamond, ps_distr_gaussian);
