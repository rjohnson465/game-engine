...
if performCutscene {
	...
	var tony = instance_create_layer(5200, 773, layer_get_id("instances_floor_1"), obj_npc_tony);
	...
	var tpath = mp_potential_path(tony.path, cg.x, cg.y, 10, 4, 0);
	with tony {
	...
	with obj_player {
		...
		path_start(p, 7, path_action_stop, true);
	}
}