...
if image_xscale == 1 && image_yscale == 1 {
	draw_sprite(spr_treedead1_mask,1,x,y);
} else {
	draw_sprite_ext(spr_treedead1_mask,1,x,y,image_xscale, image_yscale, image_angle, c_white, 1);
}
/*
if treeAlpha == 1 {
	draw_sprite(spr_tree2,1,x,y); exit;
}*/
draw_sprite_ext(spr_tree_dead_winter,1,x,y,image_xscale,image_yscale,image_angle,c_white,treeAlpha);