...
if image_xscale == 1 && image_yscale == 1 {
	...
	draw_sprite_ext(spr_treedead1_mask,1,x,y,image_xscale, image_yscale, 0, c_white, 1);
}
/*
if treeAlpha == 1 {
	draw_sprite(spr_tree2,1,x,y); exit;
}*/
draw_sprite_ext(spr_tree_dead_1,1,x,y,image_xscale,image_yscale,0,c_white,treeAlpha);