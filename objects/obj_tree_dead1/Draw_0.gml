...
if image_xscale == 1 && image_yscale == 1 {
	draw_sprite_ext(spr_treedead1_mask,1,x,y, image_xscale, image_yscale, image_angle, image_blend, 1);
} else {
	draw_sprite_ext(spr_treedead1_mask,1,x,y,image_xscale, image_yscale, image_angle, image_blend, 1);
}
/*
...
draw_sprite_ext(spr_tree_dead_1,1,x,y,image_xscale,image_yscale,image_angle,image_blend,treeAlpha);