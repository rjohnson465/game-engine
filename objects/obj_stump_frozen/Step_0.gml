...
if global.player.currentInteractableObject == id && origLayer == p.layer && interactInputReceived
	&& p.isAlive && !global.isLooting && !isInConvo {

	alert("Only an elf could knock this down", c_red);
