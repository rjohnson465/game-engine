...
if attackData.underPlayerAttackSound != noone && audio_exists(attackData.underPlayerAttackSound) {
	audio_play_sound_at(attackData.underPlayerAttackSound,x,y,depth,250,AUDIO_MAX_FALLOFF_DIST,1,0,1);
}
