...
description = "A plaid hat worn by the now extinct, very attractive and muscular lumberjacks of Everdusk Grove. Increases damage and criticals chance with one handed axes."

isSpecialHat = true;

specialHatDefenses = ds_map_create();
ds_map_replace(specialHatDefenses, 1, [[SLASH, 12],[CRUSH, 4],[PIERCE, 0], [FIRE, -25]]);
ds_map_replace(specialHatDefenses, 2, [[SLASH, 22],[CRUSH, 14],[PIERCE, 5], [FIRE, -25]]);
