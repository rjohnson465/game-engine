...
draw_text(mean(topLeftX,topLeftX+width),mean(MENUS_TOPLEFT_Y,MENUS_TOPLEFT_Y+menusHandleHeight),"Your Items");

// close button
if !gamepad_is_connected(global.player.gamePadIndex) {
	var closeButtonWidth = sprite_get_width(spr_close_button);
	var x1 = topLeftX+width-closeButtonWidth; var y1 = MENUS_TOPLEFT_Y;
