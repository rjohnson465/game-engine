...
var s = chosenRewardsLimit == 1 ? "Choose Reward" : "Choose " + string(chosenRewardsLimit) + " Rewards";
draw_text(mean(MENUS_TOPLEFT_X,MENUS_TOPLEFT_X+width),mean(MENUS_TOPLEFT_Y,MENUS_TOPLEFT_Y+menusHandleHeight), s);
