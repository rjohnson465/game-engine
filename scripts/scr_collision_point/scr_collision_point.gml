...
if(argument2)
{
    ...
    if(right-left > bottom-top)
    {
        ...
        if(collision_rectangle(left,top,(left+right)/2,bottom,argument1,true,false))
        {
            ...
            if(scr_collision_point(argument0,argument1,argument2,__left,__top,__right,__bottom))
            {
                if(__right-__left < 1)
                if(__bottom-__top < 1)
                return 1;
...
else
{
    ...
    __x = (xx+xxx)/2
    __y = (yy+yyy)/2
    return scr_collision_point(argument0,argument1,id,__left,__top,__right,__bottom);
}